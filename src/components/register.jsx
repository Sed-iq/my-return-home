  ...
  return (
    <div className="h-full">
      ...
      <div className="">
        ...
        "
          />
          <div className="w-[90%] mt-4 flex items-center">
            <Link to={"#"} className="">
              <p className="text-sm underline text-[#f6933e]">Remember me</p>
            </Link>

            <input
              type="checkbox"
              className=" w-10 h-[14.3px]"
              name="rad"
              id=""
            />
          </div>
          ...
          <div className="flex mt-4 w-[90%] flex-col">
            ...
            <div className="flex hover:bg-[black] hover:text-white my-2 items-center w-full p-4 border-[1px] rounded border-gray-200 justify-center">
              ...
              <p className="text-sm">Sign up with Twitter</p>
            </div>
          </div>
        </div>
